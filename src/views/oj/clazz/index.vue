  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <label class="el-form-item-label">年级</label>
        <el-input v-model="query.gradeId" clearable placeholder="年级" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','clazz:edit','clazz:del'])" label="操作" width="150px" align="center">
...
export default {
  ...
  cruds() {
    return CRUD({ title: '班级', url: 'api/clazz', idField: 'id', sort: 'id,desc', crudMethod: { ...crudClazz }})
  },
  data() {
    return {
      gradeList: [],
